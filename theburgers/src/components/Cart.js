  ...
  return (
    <div className="cart">
      <div className="relative group">
        ...
        <div className="absolute w-full h-full top-0 left-0 bg-black/80 opacity-0 group-hover:opacity-100 transition-all duration-400 ease-out flex items-center text-white">
